...
export default async function PlatformHome() {
  ...
  return <main className="skoolaHome">
    <header className="skoolaHeader"><nav className="skoolaWrap skoolaNav"><Brand /><div className="skoolaNavLinks"><Link href="#features">المميزات</Link><Link href="#solutions">الحلول</Link><Link href="#pricing">الأسعار</Link><Link href="#faq">الأسئلة</Link></div><div className="skoolaNavActions"><Link href="/login?role=teacher">دخول المدرس</Link><Link className="skoolaBtn small" href="/teacher-register">ابدأ كمدرس <ArrowLeft size={16} /></Link></div></nav></header>
    ...
    <footer className="skoolaFooter"><div className="skoolaWrap footerGrid"><div><Brand inverse/><p>Teach · Learn · Grow<br/>منصة تعليم حديثة تنمو معك.</p></div><div><b>المنتج</b><Link href="#features">المميزات</Link><Link href="#pricing">الأسعار</Link><Link href="/teacher-register">للمدرسين</Link></div><div><b>الحساب</b><Link href="/login?role=teacher">دخول المدرس</Link><Link href="/login?role=student">دخول الطالب</Link><Link href="/forgot-password">استعادة الحساب</Link></div><div><b>الإدارة</b><Link href="/super-admin/login">Super Admin</Link><Link href="/teacher-register">إنشاء منصة</Link></div></div><div className="skoolaWrap footerBottom"><span>© {new Date().getFullYear()} Skoola. جميع الحقوق محفوظة.</span><span>Teach · Learn · Grow</span></div></footer>
  </main>;
}