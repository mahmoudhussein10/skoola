...
const lessonSchema = z.object({
  ...
  videoUrl: z.union([z.string().trim().url().refine(isBunnyVideoUrl, "ارفع الفيديو من جهازك"), z.literal("")]).transform((v) => v || null),
  attachmentUrl: z.union([z.string().trim().url().refine(isBunnyStorageUrl, "ارفع المرفق من جهازك"), z.literal("")]).transform((v) => v || null),
  thumbnailUrl: z.union([z.string().trim().url().refine(isBunnyStorageUrl, "ارفع صورة الدرس من جهازك"), z.literal("")]).transform((v) => v || null),
