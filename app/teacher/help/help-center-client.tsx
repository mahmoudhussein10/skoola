...
const quickActions = [
  ...
  { title: "إنشاء امتحان", description: "أضف كويزًا وأسئلة داخل قسم الكورس.", href: "/teacher/content/create?mode=exam", Icon: FileQuestion },
